                    ...
                    <a class="nav-link" data-bs-toggle="dropdown" href="#"> 
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item">
                            ...
                            <?php elseif ($logueado === false): ?>
                                <li class="user-footer"> <a href="login.php" class="btn btn-default btn-flat float-end"><i style="margin-left:5px; margin-right:5px;" class="bi bi-person-circle"></i>Ingresar</a> </li> <!--end::Menu Footer-->
                            <?php endif; ?>
                        </ul>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <div class="brand-ASM">
            ...
            <div style="padding-top: 10px;"><h5><i class="fas fa-shopping-cart ml-3"></i><b>Portal de Compras</b></h5></div>
        </div>
        <!-- Sidebar -->
        <div class="sidebar">
            <!-- Sidebar Menu -->
...
<div class="col-lg-3 col-6"> <!--begin::Small Box Widget 4-->
    ...
    <footer class="app-footer"> <!--begin::To the end-->
            ...
            <strong>
                ...
                <a href="#" class="text-decoration-none">Municipio de San Miguelito. </a>All rights reserved.
            </strong>
